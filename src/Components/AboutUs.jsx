  ...
  return (
    ...
    <div className='AboutUs'>
        ...
        <p className='about'><center>Who are the Sons  of the Marianne?</center><br></br>
         ...
         did it was home release only.  We came up with a fun way to still enjoy movies and scratch that itch we were missing in  our lives. 
         The gist of "Sons of the Marianne" is simple. Every week we take a turn picking a movie. We watch it seperatley through out the week 
         whenever we can find the time. We meet on Mondays to talk about it. Simple. We have seen alot of cool movies this way. 
    ...
    <div className='rules'>Rules:
        ...
        <ul title='Rules'>
          <li>Pick a day of the week for your clubs meet!</li>
          ...
          <li>If it is your Birthday month you pick an extra movie for all to watch.</li>
        </ul>
      </div>
