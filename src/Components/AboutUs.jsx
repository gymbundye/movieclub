...
function AboutUs() {
  return (
    ...
    <div className='AboutUs'>
        ...
        <p className='about'><center>Who are the Sons  of the Marianne?</center><br></br>
         ...
         We LOVE movies. Who doesn't. But during the dark times of the Pandemic my two friends and I could no longer go out and enjoy
          ...
          The gist of "Movie Club Society" is simple. Every week we take a turn picking a movie. We watch it seperatley through out the week 
    ...
    <div className='rules'>Rules:
        ...
        <ul title='Rules'>
          <li><i>Do  </i>talk about Movie Club Society! Pick a day of the week for your clubs meet!</li>
